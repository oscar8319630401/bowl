...
export const POTTERY: Pottery[] = [
  ...
  },
  {
    ...
    date: '조선 (15 ~ 16세기)',
    height: '34cm',
    museum: '국립중앙박물관 (신수12371)',
    model: {
      url: 'models/baekja-bottle.glb',
      credit: '3D 스캔 데이터: 국립중앙박물관 (공공누리 출처표시)',
      rotation: [-Math.PI / 2, 0, 0],
    },
    summary: '군더더기 없는 곡선만으로 승부한 조선 백자 병. 실물 스캔.',
    description:
      '몸통이 풍만하게 부풀었다가 목이 길고 가늘게 뻗은 조선 백자 병이다. 술이나 물을 담던 실용 그릇인데, 무늬 하나 없이 오로지 흰빛과 곡선만으로 아름답다. 실물을 스캔한 모델이라 유약의 담황색 얼룩과 물레 자국까지 그대로 보인다.',
    glaze: 'porcelain',
    pattern: 'none',
    profile: [
      { r: 3.6, y: 0 },
    ...
    hotspots: [
      {
        ...
        angleDeg: 0,
        title: '길고 가는 목',
        body: '목이 길고 좁아서 안에 담은 술이 천천히 나오고 쉽게 쏟아지지 않는다. 손으로 쥐기도 좋다. 기능과 아름다움을 한 번에 잡은 형태다.',
      },
      {
        id: 'belly',
        yFrac: 0.4,
        angleDeg: 30,
        title: '풍만한 몸통',
        body: '아래가 넉넉하게 부풀어 안정감이 있다. 물레로 단번에 뽑아낸 곡선이라 좌우가 살짝 다른데, 그 미묘한 차이가 손맛을 준다.',
      },
      {
        id: 'plain',
        yFrac: 0.2,
        angleDeg: -35,
        title: '무늬 없는 백자',
        body: '그림도 무늬도 없다. 흰 바탕에 은은한 담황색 얼룩만 번져 있다. 조선 선비들은 이런 담백함을 가장 높이 쳤다.',
      },
    ],
    keywords: ['조선', '백자', '병', '순백'],
  },
