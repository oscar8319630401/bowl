...
export const POTTERY: Pottery[] = [
  ...
  // ─────────────────────────── 고려시대 ───────────────────────────
  {
    ...
    height: '42.1cm',
    museum: '간송미술관',
    summary: '학 69마리가 구름 사이를 나는, 고려 상감청자의 최고 걸작.',
    description:
      '고려 상감청자를 대표하는 국보다. 몸통 전체에 원 안에서 하늘로 올라가는 학과, 원 밖에서 내려오는 학이 번갈아 배치되어 있다. 학은 모두 69마리. 어깨가 넓고 아래로 갈수록 잘록해지는 매병 특유의 곡선이 아름답다.',
    glaze: 'celadon',
    pattern: 'inlayCrane',
    profile: [
      { r: 7.2, y: 0 },
    ...
    hotspots: [
      {
        ...
        body: '흙 표면에 무늬를 파낸 뒤, 그 홈에 흰 흙과 붉은 흙을 채워 넣고 긁어낸 다음 청자유를 발라 굽는다. 그러면 유약 아래에 무늬가 선명하게 박혀 있게 된다. 고려가 세계 최초로 도자기에 적용한 기법이다.',
      },
      {
        id: 'crane',
        yFrac: 0.68,
        angleDeg: 30,
        title: '69마리의 학',
        body: '원 안의 학은 하늘로 올라가고, 원 밖의 학은 아래로 내려온다. 학은 장수와 신선 세계를 뜻한다. 세어 보면 정확히 69마리다.',
      },
      {
        id: 'shoulder',
        yFrac: 0.72,
